...
namespace Bitshare.DataDecision.DBUtility
{
    /// <summary>
    /// 数据访问抽象基础类
    /// Copyright (C) Bitshare.DataDecision 
    /// </summary>
    public abstract class DbHelperSQL
    {
        ...
        /// <returns></returns>
        public static DataTable QueryPageByProc(string tableName, string orderBy, out int totalCount, string queryFields = "*", string where = null, int pageIndex = 1, int pageSize = 20)
        {
            DataTable dt = null;
            totalCount = 0;
            try
