...
function LatLonToCenter(strlatlon, showline) {
    if (strlatlon == null || strlatlon == undefined || strlatlon == "") {
        window.alert("当前经纬度值为空或者无效！");
    }
    else {
    ...
    for (var i = 0; i < markers.length; i++) {
        if (showline) {
            if (markers[i].pt.getPid() == lat + "," + lon) {
                if (i == 0) {
                    markers[i].setIcon(new MIcon("/Resource/Images/icons/起点.png", 24, 24), true);
                }
                else if (i == markers.length - 1) {
                    markers[i].setIcon(new MIcon("/Resource/Images/icons/终点.png", 24, 24), true);
                } else {
                    markers[i].setIcon(new MIcon("/Resource/Images/icons/1/icon_03.png", 16, 16), true);
                }
            ...
            if (markers[i].pt.getPid() == lat + "," + lon) {
                ...
                //                markers[i].setIcon(new MIcon("/Resource/Images/icons/小蓝.png", 21, 22), true);
                markers[i].label.setVisible(true);
            }
            else {
                //                markers[i].setIcon(new MIcon("/Resource/Images/icons/小红.png", 21, 22), true);
                markers[i].label.setVisible(false);
            }
        }
...
function SearchRoadLine() {
    ...
    if (ToDirection == "") {
        SearchByKeyword(false,RoadLine,null);
        return false;
    }
    points = new Array();
    ...
    var startPoint = item.StationPointInfos[0];
    var ss = "";
    var sTime = "";
    if (startPoint != undefined && startPoint != null) {
        ss = startPoint.PointName;
        sTime = startPoint.SETime;
    }


    tbl_temp += "<div class='poi-wrapper'>";
    tbl_temp += "<ul class='poilist' style='padding-left:0px;'>";
    tbl_temp += "   <li  class='bus-sub-line-item selected nbus hover'>";
    tbl_temp += "      <div class='top'>";
    tbl_temp += "          <div class='top-title'>";
    tbl_temp += "              <div class='top-line-num '>";
    tbl_temp += "                  " + item.RoadLine;
    tbl_temp += "              </div>";
    //    tbl_temp += "             <div class='top-line-meta' title='路'>";
    //    tbl_temp += "                  路";
    //    tbl_temp += "            </div>";
    tbl_temp += "        </div>";
    tbl_temp += "       <div class='top-content'>";

    tbl_temp += "            <div class='bline-row name'>";
    tbl_temp += "               " + ss;
    tbl_temp += "               <img width='15' height='10' class='arrow' src='http://map.baidu.com/wolfman/static/common/images/transparent.gif'>";
    tbl_temp += "               " + item.ToDirection;
    tbl_temp += "           </div>";
    tbl_temp += "            <div class='bline-row'>";
    tbl_temp += "              营运公司:";
    tbl_temp += "              ";
    tbl_temp += "               " + item.RunCompany;
    tbl_temp += "           </div>";
    tbl_temp += "          <div class='bline-row'>";
    tbl_temp += "             <span class='ntimetable-wrap'><span class='timetable-0 '>首末班 </span>： <span class='timetable-1'>" + sTime + " </span></span>";
    tbl_temp += "         </div>";
    tbl_temp += "         <div class='bline-row'>";
    tbl_temp += "             票价： <span class='ticketPrice-wrap'>" + item.TicketStyle + "</span>";
    tbl_temp += "         </div>";
    tbl_temp += "     </div>";
    tbl_temp += " </div>";
    tbl_temp += " <div class='content-des' style='display: none;'>";
    tbl_temp += "     <a class='unfold' href='javascript:void(0)'><span>途径站点 </span></a>";
    tbl_temp += " </div>";
    tbl_temp += " <div class='content' style='display: block;'>";
    tbl_temp += "   <div class='fold-wrap'>";
    tbl_temp += "       <a class='fold' href='javascript:void(0)'><span>途径站点 </span></a>";
    tbl_temp += "   </div>";
    tbl_temp += "   <ol class='station-list nbus-list'>";
    ...
    for (var j = 0; j < item.StationPointInfos.length; j++) {
        ...
        if (strLatLon != "") {
            ...
            marker = new MMarker(point, new MIcon("/Resource/Images/icons/1/icon_03.png", 8, 8));
            ...
            */
            ...
            var backgroundimage = "";
            if (j == 0) {
                marker.setIcon(new MIcon("/Resource/Images/icons/起点.png", 16, 16), true);
                linkecolor = "Red";
                backgroundimage = "background-image: url(\"/Resource/Images/point.png\");background-repeat: no-repeat;";
            }
            else if (j == item.StationPointInfos.length - 1) {
                marker.setIcon(new MIcon("/Resource/Images/icons/终点.png", 16, 16), true);
                linkecolor = "Blue";
            }

            tbl_temp += "     <li>";
            tbl_temp += "<a href='javascript:void(0)' class='street-view-point' style='visibility: visible;' onclick='javascript:openimage(\"" + item.StationPointInfos[j].StopId + "\")'></a>";
            tbl_temp += "       <div class='name-wrap'>";
            tbl_temp += "           <a class='station-name' href='javascript:void(0)'><span class='station-seq'>" + (j + 1) + "." + "<a href='javascript:LatLonToCenter(" + strLatLon + ",false);/*javascript:ToPoint(TblMap" + k + "," + j + ");*/' style='text-decoration: none;color:" + linkecolor + "'>" + labl + "</a><input type='hidden'  value='" + strLatLon + "'>";
            tbl_temp += "        </span></a>";
            tbl_temp += "   </div>";
            tbl_temp += "  </li>";
            ...
            */
            tbl_temp += "     <li>";
            tbl_temp += "       <div class='name-wrap'>";
            tbl_temp += "           <a class='station-name' href='javascript:void(0)'><span class='station-seq'>" + (j + 1) + "." + labl;
            tbl_temp += "        </span></a>";
            tbl_temp += "   </div>";
            tbl_temp += "  </li>";
        }
    ...
    $("#resultcontent").css({ 'max-height': $(window).height() - 50 - 60 - $("#route-searchbox-content").height() - 12 });
    $("#resultcontent").html(tbl_temp);
    $('.poilist li .fold-wrap').click(function () {
        if ($(this).find('a').hasClass("fold")) {
            $(this).find('a').removeClass("fold");
            $(this).find('a').addClass("unfold");
            $('.poilist li .fold-wrap').next().hide();
        }
        else {
            $(this).find('a').removeClass("unfold");
            $(this).find('a').addClass("fold");
            $('.poilist li .fold-wrap').next().show();
        }
    });
    //显示 站名
    showstationname(-1); ;
...
function SearchRoadLineByPoint() {
    ...
    for (var k = 0; k < items.length; k++) {
        ...
        tbl_temp += "<div style='cursor:pointer;'><table style='border-style: solid; border-width: 1px;border-color: #CCCCCC #999 #999 #CCCCCC;width:100%;text-align:left' "
                        ...
                        + "\").attr(\"src\",\"/Resource/Images/plus.png\");removeAllOverlays();}else{$(\"#result" + k + "\").show();$(\"#img" + k
                        + "\").attr(\"src\",\"/Resource/Images/minus.png\");DrawingLines(\"" + k + "\");}};'><tr><th><img style='border:0px' src='/Resource/Images/plus.png' id='img" + k
        ...
        for (var j = 0; j < item.StationPointInfos.length; j++) {
            ...
            if (strLatLon != "") {
                var point = new MPoint(lat, lon); //坐标
                if (j == 0) {
                    marker = new MMarker(point, new MIcon("/Resource/Images/icons/起点.png", 16, 16));
                }
                else if (j == (item.StationPointInfos.length - 1)) {
                    marker = new MMarker(point, new MIcon("/Resource/Images/icons/终点.png", 16, 16));
                }
                else {
                    marker = new MMarker(point, new MIcon("/Resource/Images/icons/1/icon_03.png", 8, 8));
                }
    ...
    for (var i = 0; i < item.length; i++) {
        ...
        if (strLatLon != null && strLatLon != "") {
            ...
            switch (PathDirection) {
                case "枢纽":
                    icourl = "/Resource/Images/icons/1/icon_01.png";
                    w = 40;
                    h = 32;
                    break;
                case "枢纽站":
                ...
                case "终点":
                    w = 24;
                    h = 24;
                    icourl = "/Resource/Images/icons/1/icon_02.png";
                    break;
                case "终点站":
                    w = 24;
                    h = 24;
                    ...
                    break;
                default:
                    icourl = "/Resource/Images/icons/1/icon_03.png";
                    break;
            }
            marker = new MMarker(point, new MIcon(icourl, w, h));
        }
        //        var new_shado = new MIconShadow("/Resource/Images/icons/shadow.png", 16, 16, -14)
        ...
        */
        ...
        PointsTr += "		<a href='javascript:void(0)'  class='camera-icon street-pano ml_5' onclick='javascript:openimage(\"" + item[i].StopId + "\")'>";
        PointsTr += "			&nbsp;";
        PointsTr += "		</a>";
        PointsTr += "	</span>";
        PointsTr += "	<span>";
        ...
        PointsTr += "		<span class='n-grey' title='" + item[i].StopId + "' style='font-size:12px;background-color:#0260d4; margin-right:10px;margin-right: 10px;color: #fff;border-radius: 2px;padding: 2px;'>";
        PointsTr += item[i].StopId;
        PointsTr += "	</span>";
        ...
        if (lineList.length != 0 && item[i].LineList != "") {
            ...
            var linestr = "";
            for (var j = 0; j < lineList.length; j++) {
                linestr += "<span style='color:#3366cc;font-size:12px;padding: 2px 8px;border: 1px solid #ededed;border-radius: 2px;margin-left: 3px;'><a href='javascript:;' onclick='javascript:searchroadline(\"" + lineList[j] + "\",\"" + item[i].StopId + "\",\"" + strLatLon + "\")'>" + lineList[j] + "</a></span>";
            }
...
function updatePos() {
    if (counter < lines.length - 1) {
        ...
        var point = new MPoint(lat, lon); //坐标点
        if (counter == 0) {
            chepic = new MMarker(point, new MIcon("/Resource/Images/icons/RedCar.png", 21, 22));
    ...
    for (var k = 0; k < items.length; k++) {
        ...
        if (k == 0) {
            tbl_temp += "<div style='cursor:pointer;'><table style='border-style: solid; border-width: 1px;border-color: #CCCCCC #999 #999 #CCCCCC;width:100%;text-align:left' "
                        ...
                        + "\").attr(\"src\",\"/Resource/Images/minus.png\");}};'><tr style='background-color:" + getRoadLineColor(k) + ";color:White;'><th><img style='border:0px' src='/Resource/Images/plus.png' id='img" + k
...
function searchroadline(RoadLine, StopId, strlatlon) {
    ...
    $('#sole-input').val(RoadLine);
    SearchByKeyword(false, RoadLine, StopId);
    return true;
                ...
                if (strLatLon != "") {
                    ...
                    if (j == 0) {
                        ...
                        if (strlatlon == strLatLon) {
                            marker = new MMarker(point, new MIcon("/Resource/Images/icons/小蓝.png", 20, 20));
                        }
                        else {
                            marker = new MMarker(point, new MIcon("/Resource/Images/icons/1/icon_03.png", 8, 8));
                        }
...
function LoadRoadsPoint(data, textStatus) {
    ...
    for (var i = 0; i < odata.Points.length; i++) {
        ...
        if (strLatLon != null && strLatLon != "") {
            ...
            marker = new MMarker(point, new MIcon("/Resource/Images/icons/小红.png", 21, 22));
            var new_shado = new MIconShadow("/Resource/Images/icons/shadow.png", 27, 34, -14)
            marker.setShadow(new_shado, true)
    ...
    for (var i = 0; i < item.length; i++) {
        ...
        switch (PathDirection) {
            ...
            case "终点":
                w = 24;
                h = 24;
                icourl = "/Resource/Images/icons/icon_02.png";
                break;
            case "终点站":
                w = 24;
                h = 24;
    ...
    if (oStop.FacilitiesList != undefined) {
        ...
        $(Facs).each(function (k) {
            if (Facs[k].FacilitiesType == "候车亭") {
                if (stationinfo != "") {
                    if (Facs[k].BaiMaNumber != undefined && Facs[k].BaiMaNumber != "") {
                        stationinfo += "、<a onclick=\"showImage('" + Facs[k].BaiMaNumber + "')\">" + Facs[k].CapitalNumber + "</a>";
...
function getCreateHeader(RoadLine, RunTime, RunCompany, ToDirection, TicketStyle, rowscount) {
    ...
    var strdiv = "<div style=\'background-color: #A6CE39; height: 129px; /*width: 262px;*/\'>"
       ...
       + " background: url(\"/Resource/Images/line.png\"); border: none;\'></div>"
       + "<div id=\'divarror\' style=\'width: 17px; height: 56px; position: relative; top: -40px; left: 28px;"
       + " background: url(\"/Resource/Images/arror.png\"); border: none;\'></div></div>";
    ...
    $("#" + strTable.id + " tr").each(function (i) {
        ...
        if (i == rowindex) {
            ...
            if (i < rowindex) {
                ...
                if (tcell.getElementsByTagName("A") != undefined && tcell.getElementsByTagName("A") != null) {
                ...
                if (tcell != null) {
                    try {
                        if (tcell.getElementsByTagName("A") != undefined && tcell.getElementsByTagName("A") != null && tcell.getElementsByTagName("A").length > 0) {
    ...
    if (i < Roads.length) {
        ...
        for (var ii = 0; ii < levelList.length; ii++) {
            ...
            if (lon != "" && lat != "") {
                ...
                var marker = new MMarker(new MPoint(lon, lat), new MIcon("/Resource/Images/icon_03.png", 16, 16));
...
function SearchByKeyword(isstop, roadline, xstopId) {
    ...
    if (roadline != undefined && roadline != null && roadline != "") {
        stopId = roadline;
    }
    if (stopId == null || stopId == undefined || stopId == "") {
        return false;
    }
    var rqurl = '/WebService.asmx/getRoadLineOrStopByKeyword';

    var jsondata = '{ keyword:"' + stopId + '",isResultStop:' + isstop + ',stopId:"' + xstopId + '" }';
    var callbackdata = Jquery_Ajax(jsondata, rqurl, false);
    var Jsonstr = $.parseJSON(callbackdata);
    var item = $.parseJSON(Jsonstr.d);
    if (item == null) {
    ...
    points = new Array();
    if (item.type == 1) {
        var roadList = item.roaddetail;
        var levellist = item.data;

        var tbl_temp = "";
        var k = 0;
        $("#result").hide();
        /*---将得到的地图数据放入表格中---*/
        for (var ii = 0; ii < roadList.length; ii++) {
            var roadLine = roadList[ii];
            tbl_temp += "<div class='poi-wrapper'>";
            tbl_temp += "<ul class='poilist' style='padding-left:0px;'>";
            tbl_temp += "   <li  class='bus-sub-line-item selected nbus hover'>";
            tbl_temp += "      <div class='top'>";
            ...
            tbl_temp += "            <div class='bline-row name'>";
            tbl_temp += "               " + roadLine.StartName;
            tbl_temp += "               <img width='15' height='10' class='arrow' src='http://map.baidu.com/wolfman/static/common/images/transparent.gif'>";
            tbl_temp += "               " + roadLine.ToDirection;
            tbl_temp += "           </div>";
            tbl_temp += "            <div class='bline-row'>";
            tbl_temp += "              营运公司:";
            tbl_temp += "              ";
            tbl_temp += "               " + roadLine.Company;
            tbl_temp += "           </div>";
            tbl_temp += "          <div class='bline-row' style='overflow:hidden;text-overflow:ellipsis;' title='" + roadLine.SETime + "'>";
            tbl_temp += "             <span class='ntimetable-wrap'><nobr>首末班:" + roadLine.SETime + "  </nobr></span>";
            tbl_temp += "         </div>";
            tbl_temp += "         <div class='bline-row'>";
            tbl_temp += "             票价： <span class='ticketPrice-wrap'>" + roadLine.TicketStyle + "</span>";
            tbl_temp += "         </div>";
            tbl_temp += "     </div>";
            tbl_temp += " </div>";
            tbl_temp += " <div class='content-des' style='display: none;'>";
            ...
            tbl_temp += "       <a class='unfold' href='javascript:void(0)'><span>途径站点 </span></a>";
            tbl_temp += "   </div>";
            tbl_temp += "   <ol class='station-list nbus-list' style='display:none;'> ";

            for (var j = 0; j < levellist.length; j++) {
                var todir = levellist[j].ToDirection;
                if (roadLine.ToDirection != todir)
                    continue;
                var strLatLon = levellist[j].Strlatlon;
                var labl = levellist[j].PointName; //标签点的名称
                var SETime = levellist[j].SETime; //首末班车时间
                var LineListleng = levellist[j].LineListleng;
                ...
                if (strLatLon != "") {
                    ...
                    var lineList = levellist[j].LineList.split("、");
                    var strlineList = "";
                    for (var i = 0; i < lineList.length; i++) {
                        if (strlineList != "") {
                            strlineList += "、<a href='javascript:;' style='text-decoration: none;' onclick='javascript:searchroadline(\"" + lineList[i] + "\",\"" + levellist[j].StopId + "\",\"" + strLatLon + "\")'>" + lineList[i] + "</a>"

                        } else {
                            strlineList += "<a href='javascript:;' style='text-decoration: none;' onclick='javascript:searchroadline(\"" + lineList[i] + "\",\"" + levellist[j].StopId + "\",\"" + strLatLon + "\")'>" + lineList[i] + "</a>"
                        }
                    }
                    var CaptionNumberInfo = getCaptionNumberInfo(levellist[j]);

                    var Facilitiestxt = "";
                    var CaptionNumberIN = 0;
                    if (levellist[j].FacilitiesSUM != undefined) {
                        var Facs = levellist[j].FacilitiesSUM;
                        $(Facs).each(function (k) {
                            var FacilitiesType = Facs[k].FacilitiesType;
                            var Numbers = Facs[k].Number;
                            if (FacilitiesType == "无电候车亭") {
                    ...
                    //站址
                    var byteLen = byteLength(levellist[j].Address);
                    var byteLenManager = 0;
                    if (byteLen > 36) {
                        byteLenManager = 15;
                    }
                    ...
                    height -= 70;
                    if (CaptionNumberInfo.split('、').length >= 4) {
                        height += 25;
                    } else {
                    ...
                    str_div += " <div>"
                    str_div += "<table style='font-size: 12px'><tr><td style='width:60px'>站点站址</td><td style='width:220px;'>" + levellist[j].StationAddress + "</td></tr><tr><td>停靠线路</td><td style='width:220px;'>" + strlineList + "</td></tr>";
                    str_div += "<tr><td>站点编号</td><td><span href='javascript:;' onclick='javascript:linkztsystem(\"" + levellist[j].StopId + "\")'>" + levellist[j].StopId + "</span></td></tr>";
                    str_div += "<tr><td>资产编号</td><td style='width:220px;'>" + CaptionNumberInfo + "</td></tr>";
                    str_div += "<tr><td>站点照片</td><td><a href='javascript:;' onclick='javascript:openimage(\"" + levellist[j].StopId + "\")'>点击查看照片</a></td></tr>";
                    str_div += "</table>";
                    str_div += "<div style='display:none;'>[" + labl + "]</div></div>";
                    /*if (Facilitiestxt != "" && Facilitiestxt != null && Facilitiestxt != undefined) {
                        str_div += "<div style='height:20px; font-size: 15px;'>" + Facilitiestxt + "</div>";
                    ...
                    else if (j == levellist.length - 1) {
                        marker.setIcon(new MIcon("/Resource/Images/icons/终点.png", 16, 16), true);
                        linkecolor = "Blue";
                    }

                    tbl_temp += "     <li>";
                    tbl_temp += "       <a href='javascript:void(0)'  class='street-view-point' style='visibility: visible;' onclick='javascript:openimage(\"" + levellist[j].StopId + "\")'></a>";
                    tbl_temp += "       <div class='name-wrap'>";
                    tbl_temp += "           <a class='station-name' href='javascript:void(0)'><span class='station-seq'>" + (levellist[j].LevelId) + "." + "<a href='javascript:LatLonToCenter(" + strLatLon + ",false);/*javascript:ToPoint(TblMap" + k + "," + j + ");*/' style='text-decoration: none;color:" + linkecolor + "'>" + labl + "</a><input type='hidden'  value='" + strLatLon + "'>";
                    tbl_temp += "        </span></a>";
                    tbl_temp += "   </div>";
                    tbl_temp += "  </li>";
                ...
                var strlinelatlon = "";
                if (roadLine.LineLatLon != undefined) {

                    var points_temp = new Array();
                    var LineLatLon = roadLine.LineLatLon.split(';')
                    for (var i = 0; i < LineLatLon.length; i++) {
                    ...
                    //将地图移动到中心位置
                    var lat = roadLine.CenterPoint.split(',')[0];
                    var lon = roadLine.CenterPoint.split(',')[1]
                    maplet.centerAndZoom(new MPoint(lat, lon), 12);
                    $("#linecenter").val(item.CenterPoint);
                    //创建笔刷将所有的点连接起来
                    var brush = new MBrush();
                    brush.arrow = false;
        ...
        if (roadline != undefined && roadline != null && roadline != "") {
            ...
            tbl_temp += "<div class='more-result'>    <a href='javascript:void(0)' map-on-click='moreResult' onclick='SearchByKeyword(true,null,null)'>查找其他名称中含有'" + stopId + "'的结果</a></div>";

        }
        $("#resultcontent").css({ 'max-height': $(window).height() - 50 - 60 - 12 });
        $("#resultcontent").html(tbl_temp);
        $('.poilist li .fold-wrap').click(function () {
            if ($(this).find('a').hasClass("fold")) {
                $(this).find('a').removeClass("fold");
        ...
        var item = item.data; tbl_temp = "";PointsTr = "";
        for (var i = 0; i < item.length; i++) {
            var marker = null;
            var labl = item[i].StationName; //标签点的名称
...
function fenyeshow(fun) {


    if (ddlist.length > 0 && ddlist != undefined)
        lastNum = ddlist[0].id;

    //分页链接变换
    strS = '<a href="#" onclick="' + fun + '(0)">首页</a>  ';
    ...
    for (var i = startPage; i <= endPage; i++) {
        if (i == nowPage) {
            strC += '<a href="###" style="color:red;font-weight:700;" onclick="' + fun + '(' + i + ')">' + (i + 1) + '</a> ';
        }
        else {
            strC += '<a href="###" onclick="' + fun + '(' + i + ')" style="display: inline-block;border: #e7ecf0 solid 1px; padding: 5px 6px 3px;text-decoration: none;">' + (i + 1) + '</a> ';
        }
    }
    strE = ' <a href="###" onclick="' + fun + '(' + (PagesLen - 1) + ')">尾页</a></li>  ';
    strE2 = "<div style='text-align: center;margin:10px 0;'>" + (parseInt(nowPage) + 1) + "/" + PagesLen + "页" + "  共" + ddlist.length + "条</div>";

    document.getElementById("changpage").innerHTML = "<div style='text-align: center;'>" + strS + strC + strE + strE2 + "</div>"; ;


    $("#BuildDataDiv >ul>li").mouseover(function () {
