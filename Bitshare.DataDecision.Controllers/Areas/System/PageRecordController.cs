...

{
    public class PageRecordController : Controller
    {
        ...
        public ActionResult GetDataList(string Rid = null, int page = 1, int rows = 50, string startDate = null, string endDate=null, string sidx = "", string sord = "asc")
        {
            #region 通过存储过程获得数据
           ...
           // string PageUrl = Request["PageUrl"];
            ...
            int totalCount = 0;
            string queryFields = " PageTitle, PageUrl, count(Rid)  as CountSum ";
