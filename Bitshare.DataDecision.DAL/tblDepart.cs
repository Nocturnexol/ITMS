...
namespace Bitshare.DataDecision.DAL
{
    ...
    public partial class tblDepart
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Rid", "tblDepart"); 
		}
		...
		public bool Exists(int Rid)
		{
			...
			strSql.Append("select count(1) from tblDepart");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tblDepart(");
			strSql.Append("dept,remark)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tblDepart set ");
		...
		public bool Delete(int Rid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tblDepart ");
			strSql.Append(" where Rid=@Rid");
			SqlParameter[] parameters = {
					new SqlParameter("@Rid", SqlDbType.Int,4)
			};
		...
		public Bitshare.DataDecision.Model.tblDepart GetModel(int Rid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Rid,dept,remark from tblDepart ");
			strSql.Append(" where Rid=@Rid");
			SqlParameter[] parameters = {
					new SqlParameter("@Rid", SqlDbType.Int,4)
			};
			...
			Bitshare.DataDecision.Model.tblDepart model=new Bitshare.DataDecision.Model.tblDepart();
		...
		/// 得到一个对象实体
		/// </summary>
		public Bitshare.DataDecision.Model.tblDepart DataRowToModel(DataRow row)
		{
			Bitshare.DataDecision.Model.tblDepart model=new Bitshare.DataDecision.Model.tblDepart();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Rid,dept,remark ");
			strSql.Append(" FROM tblDepart ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tblDepart T ");
