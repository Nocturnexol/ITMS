...
namespace Bitshare.DataDecision.DAL
{
    ...
    public partial class tblButtonName
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Rid", "tblButtonName"); 
		}
		...
		public bool Exists(int Rid)
		{
			...
			strSql.Append("select count(1) from tblButtonName");
		...
		public bool Delete(int Rid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tblButtonName ");
			strSql.Append(" where Rid=@Rid");
			SqlParameter[] parameters = {
					new SqlParameter("@Rid", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Rid,ButtonName,Remark ");
			strSql.Append(" FROM tblButtonName ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Rid,ButtonName,Remark ");
			strSql.Append(" FROM tblButtonName ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tblButtonName T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tblButtonName";
