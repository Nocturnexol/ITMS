...
namespace Bitshare.DataDecision.BLL
{
	...
	{
		private readonly Bitshare.DataDecision.DAL.tblDetailButton dal=new Bitshare.DataDecision.DAL.tblDetailButton();
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.tblDetailButton> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.tblDetailButton> DataTableToList(DataTable dt)
		{
			List<Bitshare.DataDecision.Model.tblDetailButton> modelList = new List<Bitshare.DataDecision.Model.tblDetailButton>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Bitshare.DataDecision.Model.tblDetailButton model;
