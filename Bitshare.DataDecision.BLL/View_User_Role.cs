...
namespace Bitshare.DataDecision.BLL
{
    ...
    {
        private readonly Bitshare.DataDecision.DAL.View_User_Role dal = new Bitshare.DataDecision.DAL.View_User_Role();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Bitshare.DataDecision.Model.View_User_Role> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Bitshare.DataDecision.Model.View_User_Role> DataTableToList(DataTable dt)
        {
            List<Bitshare.DataDecision.Model.View_User_Role> modelList = new List<Bitshare.DataDecision.Model.View_User_Role>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Bitshare.DataDecision.Model.View_User_Role model;
