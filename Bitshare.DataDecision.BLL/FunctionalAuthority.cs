...
namespace Bitshare.DataDecision.BLL
{
	...
	{
		private readonly Bitshare.DataDecision.DAL.FunctionalAuthority dal=new Bitshare.DataDecision.DAL.FunctionalAuthority();
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.FunctionalAuthority> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.FunctionalAuthority> DataTableToList(DataTable dt)
		{
			List<Bitshare.DataDecision.Model.FunctionalAuthority> modelList = new List<Bitshare.DataDecision.Model.FunctionalAuthority>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Bitshare.DataDecision.Model.FunctionalAuthority model;
