...
namespace Bitshare.DataDecision.BLL
{
	...
	{
		private readonly Bitshare.DataDecision.DAL.tblGroupButton dal=new Bitshare.DataDecision.DAL.tblGroupButton();
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.tblGroupButton> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.tblGroupButton> DataTableToList(DataTable dt)
		{
			List<Bitshare.DataDecision.Model.tblGroupButton> modelList = new List<Bitshare.DataDecision.Model.tblGroupButton>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Bitshare.DataDecision.Model.tblGroupButton model;
