...
namespace Bitshare.DataDecision.BLL
{
	...
	{
		private readonly Bitshare.DataDecision.DAL.tblPageDetail dal=new Bitshare.DataDecision.DAL.tblPageDetail();
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.tblPageDetail> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.tblPageDetail> DataTableToList(DataTable dt)
		{
			List<Bitshare.DataDecision.Model.tblPageDetail> modelList = new List<Bitshare.DataDecision.Model.tblPageDetail>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Bitshare.DataDecision.Model.tblPageDetail model;
