...
namespace Bitshare.DataDecision.BLL
{
	...
	{
		private readonly Bitshare.DataDecision.DAL.sys_role dal=new Bitshare.DataDecision.DAL.sys_role();
		public sys_role()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.sys_role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Bitshare.DataDecision.Model.sys_role> DataTableToList(DataTable dt)
		{
			List<Bitshare.DataDecision.Model.sys_role> modelList = new List<Bitshare.DataDecision.Model.sys_role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Bitshare.DataDecision.Model.sys_role model;
